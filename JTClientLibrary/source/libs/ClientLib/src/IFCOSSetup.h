...
class CIFPetFilterButton : public CIFButton {
    GFX_DECLARE_DYNCREATE(CIFPetFilterButton)
...
//FUN_007a83e0
    ...
    ~CIFCOSSetup(void);
    void On_BtnClick();
    void EnsurePetFilterButton();
    void UpdatePetFilterButtonLayout(bool visible);
    /// \address 007a86c0
