...
public:
    ...
    void LoadLuckySpinRewards(CMsgStreamBuffer &msg);
    void LuckySpinResult(CMsgStreamBuffer &msg);
    void TradeSellCaptchaRequest(CMsgStreamBuffer &msg);
    void LoadSpecialOffers(CMsgStreamBuffer &msg);
    void SpecialOfferPurchaseResult(CMsgStreamBuffer &msg);
    void LoadKillerAnimations(CMsgStreamBuffer &msg);
    void KillerAnimationActionResult(CMsgStreamBuffer &msg);
    void TriggerKillerAnimation(CMsgStreamBuffer &msg);
    void DropLogsResponse(CMsgStreamBuffer &msg);
    void MonsterPossibleDropsResponse(CMsgStreamBuffer &msg);
    void PvpChallengePacket(CMsgStreamBuffer &msg);
    void OfflineStallActivationResult(CMsgStreamBuffer &msg);
...
private:
    ...
    void UpdateNameColor(CMsgStreamBuffer &msg);
    void RemoveNameColor(CMsgStreamBuffer &msg);
    ...
    void ActivateTag(CMsgStreamBuffer &msg);
    void DeactivateTag(CMsgStreamBuffer &msg);
    void LoadChest(CMsgStreamBuffer &msg);
    void LoadChestV2(CMsgStreamBuffer &msg);
    ...
    void UpdateStallPriceType(CMsgStreamBuffer &msg);
    ...
    void WebViewerConfig(CMsgStreamBuffer &msg);
    ...
    void UpdateEventSuit(CMsgStreamBuffer &msg);
    ...
    void HandleCircle(CMsgStreamBuffer &msg);
    void SERVER_HANDLER_BLOCKATTACK(CMsgStreamBuffer &msg);
