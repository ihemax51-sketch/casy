...
set (GenerateProductVersionCurrentDir ${CMAKE_SOURCE_DIR}/cmake)
...
function(generate_product_version outfiles)
    ...
    set (_VersionInfoFile ${CMAKE_SOURCE_DIR}/source/SilkroadOnline/TOOLS_PLUGINS/3rd-party/version/src/VersionInfo.h)
    set (_VersionResourceFile ${CMAKE_SOURCE_DIR}/source/SilkroadOnline/TOOLS_PLUGINS/3rd-party/version/resrc/VersionResource.rc)
    configure_file(
            ${CMAKE_SOURCE_DIR}/source/SilkroadOnline/TOOLS_PLUGINS/3rd-party/version/resrc/VersionInfo.in
            ${_VersionInfoFile}
            @ONLY)
    configure_file(
            ${CMAKE_SOURCE_DIR}/source/SilkroadOnline/TOOLS_PLUGINS/3rd-party/version/resrc/VersionResource.rc
