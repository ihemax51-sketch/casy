...
ALTER PROCEDURE [dbo].[_MarsStartPackScroll_2]
    @CharID int,
    @ItemRefID int,
    @Operation tinyint
AS
BEGIN
    ...
    (
        RewardOrder int IDENTITY(1,1) NOT NULL,
    ...
    BEGIN
        ...
        VALUES
            ...
            ('ITEM_MARSEDIT_HWAN20', 1),
            ('ITEM_MALL_GLOBAL_CHATTING', 20),
            ('ITEM_MALL_NASRUN_ARCHEMY_MAGICSTONE_UMDU', 5),
            ('ITEM_ETC_NASRUN_ARCHEMY_UPGRADE_STONE', 1),
            ('ITEM_ETC_NASRUN_ARCHEMY_UPGRADE_STONE', 1),
            ('ITEM_ETC_NASRUN_ARCHEMY_UPGRADE_STONE', 1),
            ('ITEM_ETC_NASRUN_ARCHEMY_UPGRADE_STONE', 1),
            ('ITEM_ETC_NASRUN_ARCHEMY_UPGRADE_STONE', 1);
