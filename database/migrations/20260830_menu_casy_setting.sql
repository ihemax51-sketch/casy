/*
    Adds the optional CASY client menu setting and extends the explicit setting
    type catalog used by dbo.vw_Settings_InvalidValues.
*/
...
BEGIN TRY
    ...
    (
        ...
        THROW 51001, 'MenuCasy is duplicated in dbo.System_Settings.', 1;
    ...
    BEGIN
        EXEC sys.sp_executesql N'
            ...
            SET Category = N''Client.UI'',
                DisplayOrder = 236,
                Description = N''Use the compact transparent CASY main menu.''
            WHERE SettingName = N''MenuCasy'';';
    END;
...
PRINT 'MenuCasy setting added and registered as a boolean client UI setting.';
GO
