USE [KMTGuard];
GO
-- Generated before the KMTGuard procedure organization migration.
-- A verified COPY_ONLY database backup is the authoritative rollback source.

SET ANSI_NULLS ON;
GO
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[___CustomGlowSwitcher]
...
BEGIN
	...
	BEGIN
	EXEC _SendNoticeByCharName16 @CharName16, 3, N'Bu iteme daha önce aynı glow eklenmiştir.'
	return;
	END
	IF EXISTS (Select 1 from SRO_VT_SHARD.._RefObjCommon
	where CodeName128 = @Result)
	BEGIN
	EXEC __LiveConsumeAndMutateItem @CharID, @TargetSlot, @Result, @UsedItemSlot, 1
	END
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[___CustomModelSwitcher]
	@CharName16 varchar(25),
	@CharID int,
...
BEGIN
    ...
    BEGIN
		EXEC _SendNoticeByCharName16 @CharName16, 3, N'Bu iteme daha önce aynı model eklenmiştir.'
        RETURN;
    END
...
END
	...
	BEGIN
	EXEC __LiveConsumeAndMutateItem @CharID, @TargetSlot, @TargetItemCodeName, @UsedItemSlot, 1
	END
...
-- =============================================
CREATE PROCEDURE [dbo].[___HandleNPCList]
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[__ChangeGrantName]
    @CharID INT,
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[__RessurrectCharacter]
		@CharID int
AS		
...
CREATE PROCEDURE [dbo].[__GetUpAtPos]
	@CHARID int,
	@GameWorldID int,
	@RegionId int,
	@PosX int,
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[__DeSpawnMonsterByObjID]
	@CodeName128 varchar(128)
AS
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[__KillNPCbyWorldId]
	@CodeName128 varchar(128),
	@WorldID int
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[__LiveConsumeAndMutateItem]
    @CharID INT,
	@MutateSlot tinyint,
    @CodeName128 VARCHAR(128),
	@ConsumeSlot tinyint,
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[__LiveConsumeItem]
    @CharID INT,
	@Slot tinyint,
    @ReduceAmount int
AS
...
CREATE   PROCEDURE [dbo].[__LiveGold]
    @CharID int,
    @Gold bigint,
    @AddOrRemove int
AS
...
SET QUOTED_IDENTIFIER ON;
GO
create PROCEDURE [dbo].[__LiveMutateItem]
    @CharID INT,
	@Slot tinyint,
    @CodeName128 VARCHAR(128)
AS
...
SET QUOTED_IDENTIFIER ON;
GO
create PROCEDURE [dbo].[__LiveSilk]
    @CharID INT,
	@nSilk int,
	@nSilkGift int,
	@nSilkPoint int
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[__RemoveLiveBuffbySkillID]
		@CharID int,
	@SkillID int
AS		
...
SET QUOTED_IDENTIFIER ON;
GO
create PROCEDURE [dbo].[__SendLiveBuffbyCodeName]
	@CharID int,
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[__SendLiveBuffLimitless]
	@CharID int,
	@SkillID int
AS		
...
CREATE PROCEDURE [dbo].[__SendLiveCape]
    @CharID INT,
    @CapeID INT
AS
BEGIN
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[__SpawnMonsterAtNearbyCharacter]
	@CharID int,
	@MonsterID int
AS		
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[__SpawnMonsterAtPosition]
	@MonsterID int,
	@GameWorldID int,
	@RegionId int,
	@PosX int,
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[__SpawnNPC]
	@CodeName128 varchar(128),
	@GameWorldID int,
	@RegionId int,
	@PosX int,
...
CREATE PROCEDURE [dbo].[__TeleportIfInSafeZoneAndNoJob]
	@CHARID int,
	@GameWorldID int,
	@RegionId int,
	@PosX int,
...
CREATE   PROCEDURE [dbo].[__TeleportToPosition]
    @CharID int,
    @GameWorldID int,
    @RegionId int,
    @PosX int,
...
CREATE   PROCEDURE [dbo].[__TeleportToPositionWithFreeze]
    @CharID int,
    @GameWorldID int,
    @RegionId int,
    @PosX int,
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[__TeleportToTownAllbyWorldID]
	@WorldID int
AS		
...
CREATE   PROCEDURE [dbo].[__TeleportToTownbyCharID]
    @CharID int
AS
BEGIN
    SET NOCOUNT ON;
...
CREATE PROCEDURE [dbo].[_Achievement_AddNewChar]
    @CharID INT
AS
BEGIN
    SET NOCOUNT ON;
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_AddColorToTitleManagerColor]
	@CharID int,
...
SET QUOTED_IDENTIFIER ON;
GO
create PROCEDURE [dbo].[_AddIconToIconManager]
	@CharID int,
	@IconID int,
	@Side tinyint
AS		
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE   PROCEDURE dbo._AddItemToChest2
    @CharID INT,
    @ItemID INT,
    @Quantity INT,
    @Type VARCHAR(100),
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_AddTitleToTitleManager]
	@CharID int,
	@TitleID tinyint
AS		
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_AttendanceEvent]
    @CharID int,
    @Date date,
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[_AuthCharLogin]
    -- Add the parameters for the stored procedure here
    @UserName VARCHAR(32),
    @Password varchar(32)
AS
...
CREATE   PROCEDURE dbo._AutoEventEnqueueReload
...
CREATE   PROCEDURE dbo._AutoEventEnqueueStart
...
CREATE   PROCEDURE dbo._AutoEventEnqueueStop
    @RequestedBy nvarchar(64) = N'Scheduler'
AS
BEGIN
    SET NOCOUNT ON;
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE   PROCEDURE dbo._BattlePass_CreateMission
    @SeasonID INT,
...
CREATE   PROCEDURE dbo._BattlePass_CreateMissionByCodeName
    @SeasonID INT,
    @MissionType VARCHAR(12),
    @EventType VARCHAR(40),
...
BEGIN
    ...
    EXEC dbo._BattlePass_CreateMission
...
CREATE   PROCEDURE dbo._BattlePass_GrantXP
    @SeasonID INT,
    @JID INT,
    @CharID INT,
    @Amount BIGINT
...
CREATE PROCEDURE [dbo].[_Filter_GetDropLogs]
    @Page INT = 1,
    @PageSize INT = 10,
...
CREATE   PROCEDURE [dbo].[_Filter_GetMonsterPossibleDrops]
    @MonsterID INT
AS
BEGIN
    SET NOCOUNT ON;
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo]._FilterStartup
...
CREATE   PROCEDURE dbo._GetDropLogs
    @TopCount INT = 500
AS
BEGIN
    SET NOCOUNT ON;
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[_GetFellowPetID64]
	-- Add the parameters for the stored procedure here
	@CharID INT,
	@Slot smallint,
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[_GetItemInfo]
	-- Add the parameters for the stored procedure here
	@CharID INT,
	@SlotIndex TINYINT,
...
-- Description:	<Description,,>
-- =============================================
create PROCEDURE [dbo].[_HandleCharSettings]
	-- Add the parameters for the stored procedure here
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[_HandleFellowData]
	-- Add the parameters for the stored procedure here
	@ID64 bigint,
...
SET QUOTED_IDENTIFIER ON;
GO
create PROCEDURE [dbo].[_HandleHwidList]
    @Active tinyint,
    @CharID int,
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[_HandleIcons]
	-- Add the parameters for the stored procedure here
	@CharName16 VARCHAR(32),
	@IconID int,
	@Side tinyint 
...
CREATE PROCEDURE [dbo].[_HandleMobKilled] 
    @RefObjID        INT,
    @KilledWorldID   INT,
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[_HandleNewTitles]
	-- Add the parameters for the stored procedure here
	@CharName16 VARCHAR(32),
	@TitleID tinyint
AS
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[_HandleSavedLocation]
	-- Add the parameters for the stored procedure here
	@CharID int, 
	@LocationID int, 
	@RegionID int, 
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[_HandleTitleColors]
	-- Add the parameters for the stored procedure here
	@CharName16 VARCHAR(32),
...
CREATE PROCEDURE [dbo].[_HandleUniqueAchievements]
    @RefObjID    INT,
...
CREATE PROCEDURE dbo._HandleUniqueAchievements_ByRef
    @RefObjID        INT,
...
CREATE PROCEDURE [dbo].[_IncreaseJobKillCounterbyWorldID]
@WorldID int,
...
CREATE PROCEDURE [dbo].[_IncreaseKillCounterbyWorldID]
@WorldID int,
@CharName16 varchar(12),
@Kill int
AS
...
create PROCEDURE [dbo].[_IncreaseTeamKillCounterbyWorldID]
@WorldID int,
@CharName16 varchar(12),
@Kill int,
@Team int
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_LiveSkillManagementbyWorldID]
    @WorldID INT,
	@State bit
AS 
BEGIN
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_LiveTeleportManagementbyWorldID]
    @Gate INT,
	@State bit
AS 
BEGIN
...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN TRY
            EXEC KMTGuard.dbo.__LiveGold @CharID=@CharID, @Gold=@cost, @AddOrRemove=0;  -- 0=Remove
        END TRY
        BEGIN CATCH
...
CREATE PROCEDURE [dbo].[_MakeNewJobKillCounterbyWorldID]
@WorldID int
AS
...
CREATE PROCEDURE [dbo].[_MakeNewKillCounterbyWorldID]
@Title varchar(50),
@WorldID int
AS
...
CREATE PROCEDURE [dbo].[_MakeNewTeamKillCounterbyWorldID]
@WorldID int
AS
...
create PROCEDURE [dbo].[_MakeNewTimerbyRegionID]
@Seconds int,
@RegionID int
AS
...
create PROCEDURE [dbo].[_MakeNewTimerbyWorldID]
@Seconds int,
@WorldID int
AS
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_OnAlchemySuccess_EDIT]
	@CharID int,
	@CharName varchar(25),
	@ItemID int,
	@Plus tinyint,
...
BEGIN
    ...
    IF @WID IS NULL
    BEGIN
        EXEC KMTGuard.dbo._SendNoticeByCharId
             @CharID     = @CharID,
             @NoticeType = 3,
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_OnCharacterGetUp_EDIT]
	@CharID int,
	@CharName varchar(25),
	@LatestRegion int,
	@LatestWorld int,
...
BEGIN
    ...
    BEGIN TRY
        EXEC KMTGuard.dbo.__TeleportToTownbyCharID @CharID = @DeadCharID;
    END TRY
    BEGIN CATCH
        ...
        BEGIN TRAN;
            ...
            BEGIN
                ...
                BEGIN
                    ...
                    EXEC @rc = [KMTGuard].[dbo].[__LiveSilk]
                         @CharID     = @CharID,
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_OnGameServerStartup_EDIT]
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[_OnItemPurchasedFromNPC_EDIT]
	-- Add the parameters for the stored procedure here
	@CharID INT,
	@Slot_From tinyint,
	@BuyedItemID int
...
BEGIN
	...
	EXEC _UpdateAchievement @CharID, 8, 8, @TotalPrice
END
...
create PROCEDURE [dbo].[_OnNewItemMallPurchased_EDIT]
    @JID int,
    @CharID int,
    @CharName16 varchar(16),
    @ItemID int,
...
BEGIN
    ...
    EXEC _UpdateAchievement @CharID, 9, 9, @Silk;
    ...
    BEGIN
        ...
        EXEC _UpdateIconRightSide @CharName16, 6; -- iron
    END
    ...
    BEGIN
        ...
        EXEC _UpdateIconRightSide @CharName16, 5; -- bronze
    END
    ...
    BEGIN
        ...
        EXEC _UpdateIconRightSide @CharName16, 4; -- silver
    END
    ...
    BEGIN
        ...
        EXEC _UpdateIconRightSide @CharName16, 3; --- gold
    END
    ...
    BEGIN
        ...
        EXEC _UpdateIconRightSide @CharName16, 2; --- platinum
    END
    ...
    BEGIN
        ...
        EXEC _UpdateIconRightSide @CharName16, 1; --- vip
    END
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_OnPartyJoined_EDIT]
	@CharID int,
	@CharName varchar(25),
...
CREATE   PROCEDURE [dbo].[_OnPartyMatchingCreated_EDIT]
    @CharID           INT,
    @CharName         VARCHAR(25),
    @CurrentRegionId  SMALLINT,
    @CurrentWorldID   INT,
...
SET QUOTED_IDENTIFIER ON;
GO
create PROCEDURE [dbo].[_OnSelectableScroll_Used_EDIT] 
...
BEGIN
    EXEC ___CustomGlowSwitcher @CharName16, @CharID, @TargetItemCodeName, 'GLOW_1', @TargetItemSlot, @UsedItemSlot
END
END
...
IF @TargetItemCodeName LIKE '%_08_C_RARE%' OR @TargetItemCodeName LIKE '%_08_B_RARE%'
BEGIN
    EXEC ___CustomGlowSwitcher @CharName16, @CharID, @TargetItemCodeName, 'GLOW_2', @TargetItemSlot, @UsedItemSlot
END
...
IF @TargetItemCodeName LIKE '%_08_C_RARE%' OR @TargetItemCodeName LIKE '%_08_B_RARE%'
BEGIN
    EXEC ___CustomGlowSwitcher @CharName16, @CharID, @TargetItemCodeName, 'GLOW_3', @TargetItemSlot, @UsedItemSlot
END
...
IF @TargetItemCodeName LIKE '%_08_C_RARE%' OR @TargetItemCodeName LIKE '%_08_B_RARE%'
BEGIN
    EXEC ___CustomGlowSwitcher @CharName16, @CharID, @TargetItemCodeName, 'GLOW_4', @TargetItemSlot, @UsedItemSlot
END
...
IF @TargetItemCodeName LIKE '%_08_C_RARE%' OR @TargetItemCodeName LIKE '%_08_B_RARE%'
BEGIN
    EXEC ___CustomModelSwitcher @CharName16, @CharID, @TargetItemCodeName, 'MODEL09', @TargetItemSlot, @UsedItemSlot
END
...
IF @TargetItemCodeName LIKE '%_08_C_RARE%' OR @TargetItemCodeName LIKE '%_08_B_RARE%'
BEGIN
    EXEC ___CustomModelSwitcher @CharName16, @CharID, @TargetItemCodeName, 'MODEL10', @TargetItemSlot, @UsedItemSlot
END
...
IF @TargetItemCodeName LIKE '%_08_C_RARE%' OR @TargetItemCodeName LIKE '%_08_B_RARE%'
BEGIN
    EXEC ___CustomModelSwitcher @CharName16, @CharID, @TargetItemCodeName, 'MODEL11', @TargetItemSlot, @UsedItemSlot
END
...
IF @TargetItemCodeName LIKE '%_08_C_RARE%' OR @TargetItemCodeName LIKE '%_08_B_RARE%'
BEGIN
    EXEC ___CustomModelSwitcher @CharName16, @CharID, @TargetItemCodeName, 'MODEL11_A', @TargetItemSlot, @UsedItemSlot
END
...
IF @TargetItemCodeName LIKE '%_08_C_RARE%' OR @TargetItemCodeName LIKE '%_08_B_RARE%'
BEGIN
    EXEC ___CustomModelSwitcher @CharName16, @CharID, @TargetItemCodeName, 'MODEL11_B', @TargetItemSlot, @UsedItemSlot
END
...
IF @TargetItemCodeName LIKE '%_08_C_RARE%' OR @TargetItemCodeName LIKE '%_08_B_RARE%'
BEGIN
    EXEC ___CustomModelSwitcher @CharName16, @CharID, @TargetItemCodeName, 'MODEL12', @TargetItemSlot, @UsedItemSlot
END
...
IF @TargetItemCodeName LIKE '%_08_C_RARE%' OR @TargetItemCodeName LIKE '%_08_B_RARE%'
BEGIN
    EXEC ___CustomModelSwitcher @CharName16, @CharID, @TargetItemCodeName, 'MODEL13', @TargetItemSlot, @UsedItemSlot
END
...
CREATE PROCEDURE [dbo].[_OnStallCreate]
    @CharID       INT,
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_OnTeleportControl_EDIT]
    @CharID INT,
    @RefTeleportID INT,
...
CREATE PROCEDURE [dbo].[_OnTradeGoodsBuyingComplete_EDIT]
    @CharID INT,
    @Charname VARCHAR(25),
    @NpcID INT,
    @Petid INT,
    ...
    BEGIN TRY
        BEGIN TRAN;
            ...
            BEGIN
                ...
                EXEC KMTGuard.dbo._SendNoticeByCharId @CharID, 6, @notice;
            ...
            BEGIN
                ...
                BEGIN
                    ...
                    EXEC KMTGuard.dbo._SendNoticeByCharId @CharID, 6, @notice2;
...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            BEGIN
                ...
                BEGIN
                    EXEC KMTGuard.dbo._TradeBonus_Grant_Rolling
                        @CharID = @TCharID,
                        @CharName = @TCharName,
    ...
    BEGIN CATCH
        ...
        EXEC KMTGuard.dbo._SendNoticeByCharId @CharID, 6, @msg;
    END CATCH
END
*/
GO
...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            EXEC KMTGuard.._SendNoticeToServer
                 @NoticeType = 2,
                 @Notice     = @towerMsg;
        END
    END
...
CREATE PROCEDURE [dbo].[_ProcessAddLogChar]
@CharID		int,
@EventID	tinyint,
@Data1		int,
@Data2		int,
...
if(@RefObjID < 14875)
begin
EXEC __SendLiveBuffLimitless @CharID, 35406
end
*/
...
BEGIN
    ...
    IF(@SilkRank = 1)
    BEGIN
        EXEC __SendLiveBuffbyCodeName @CharID, 'SKILL_VIP_BUFF_01';
		EXEC _SendNoticeByCharId @CharID, 8, 'You''re VIP (VIP) User.'
    END
    ELSE IF(@SilkRank = 2)
    BEGIN
        EXEC __SendLiveBuffbyCodeName @CharID, 'SKILL_VIP_BUFF_02';
		EXEC _SendNoticeByCharId @CharID, 8, 'You''re VIP (Platinum) User.'
    END
    ELSE IF(@SilkRank = 3)
    BEGIN
        EXEC __SendLiveBuffbyCodeName @CharID, 'SKILL_VIP_BUFF_03';
		EXEC _SendNoticeByCharId @CharID, 8, 'You''re VIP (Gold) User.'
    END
    ELSE IF(@SilkRank = 4)
    BEGIN
        EXEC __SendLiveBuffbyCodeName @CharID, 'SKILL_VIP_BUFF_04';
		EXEC _SendNoticeByCharId @CharID, 8, 'You''re VIP (Silver) User.'
    END
    ELSE IF(@SilkRank = 5)
    BEGIN
        EXEC __SendLiveBuffbyCodeName @CharID, 'SKILL_VIP_BUFF_05';
		EXEC _SendNoticeByCharId @CharID, 8, 'You''re VIP (Bronze) User.'
    END
    ELSE IF(@SilkRank = 6 OR @SilkRank IS NULL)
    BEGIN
        EXEC __SendLiveBuffbyCodeName @CharID, 'SKILL_VIP_BUFF_06';
		EXEC _SendNoticeByCharId @CharID, 8, 'You''re New (Iron) User.'
    END
END
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_RemoveIconLeftSide]
...
SET QUOTED_IDENTIFIER ON;
GO
create PROCEDURE [dbo].[_RemoveIconRightSide]
	@CharName16 as varchar(16)
AS		
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_RemoveNameColor]
	@CharName16 varchar(16)
AS		
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_RemoveNewTitle]
	@CharName16 varchar(16)
AS		
...
SET QUOTED_IDENTIFIER ON;
GO
create PROCEDURE [dbo].[_RemoveTitleColor]
	@CharName16 varchar(16)
AS		
...
-- Description:	<Description,,>
-- =============================================
CREATE PROCEDURE [dbo].[_SaveMacroAutoPotionSetting]
	-- Add the parameters for the stored procedure here
	@CharID int,
	@Slot tinyint,
	@Active bit,
...
CREATE   PROCEDURE dbo._self_Teleport
    @CharID INT
AS
BEGIN
    SET NOCOUNT ON;
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_SendDisconnectByCharID]
	@CharID int
AS		
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_SendDisconnectByCharName16]
	@CharName16 varchar(16)
AS		
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_SendDisconnectToAllServer]
...
SET QUOTED_IDENTIFIER ON;
GO
create PROCEDURE [dbo].[_SendMapPingByCharId]
	@CharID int,
	@RegionID int,
	@PosX int,
	@PosZ int,
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_SendNoticeByCharId]
	@CharID int,
	@NoticeType int,
	@Notice varchar(max)
AS		
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_SendNoticeByCharName16]
	@CharName16 varchar(16),
	@NoticeType int,
	@Notice varchar(max)
AS		
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_SendNoticeToServer]
	@NoticeType int,
	@Notice varchar(max)
AS		
...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN TRAN;
            ...
            BEGIN
                ...
                BEGIN
                    ...
                    EXEC KMTGuard.._SendNoticeByCharName16 @Name16, 6, @CapMsg;
                    RETURN;
                END
        ...
        -- ✅ positional call (NO named params)
        EXEC KMTGuard.._SendNoticeByCharName16 @Name16Ok, 6, @msg;
    ...
    BEGIN CATCH
        ...
        -- ✅ positional call (NO named params)
        EXEC KMTGuard.._SendNoticeByCharName16 @Name16Err, 6, @errMsg;
    END CATCH
END
...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN TRAN;
            ...
            EXEC KMTGuard.dbo.__LiveGold @CharID, @Gold, 1;
        ...
        EXEC KMTGuard.dbo._TradeRolling_BumpMember @CharID;
    ...
    BEGIN CATCH
        ...
        EXEC KMTGuard.dbo._SendNoticeByCharId @CharID, 6, @errMsg;
    END CATCH
END
...
CREATE PROCEDURE dbo._TradeRolling_BumpMember
    @CharID INT
AS
BEGIN
    SET NOCOUNT ON;
...
CREATE PROCEDURE [dbo].[_UpdateAchievement]
    @CharID                     INT,
    @RefAchievementID           INT,
    ...
    BEGIN
        ...
        BEGIN
            ...
            BEGIN
                ...
                EXEC dbo._SendNoticeByCharId @CharID, 8, 'Achievement Completed.';
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_UpdateClientConfig]
    @CharID int,
    @SlotSeq tinyint,
    @SlotType tinyint,
    @Data int
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_UpdateIconLeftSide]
	@CharName16 as varchar(16),
	@IconID int
AS		
...
SET QUOTED_IDENTIFIER ON;
GO
create PROCEDURE [dbo].[_UpdateIconRightSide]
	@CharName16 as varchar(16),
	@IconID int
AS		
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_UpdateMacroSetting]
    @CharID int,
    @AutoPotion bit,
    @AutoSkill bit,
    @AutoHunt bit,
...
SET QUOTED_IDENTIFIER ON;
GO
CREATE PROCEDURE [dbo].[_UpdateNameColor]
            @CharName16 varchar(16),
            @ColorCode varchar(100)
        AS
        BEGIN
...
SET QUOTED_IDENTIFIER ON;
GO
create PROCEDURE [dbo].[_UpdateNewTitle]
	@CharName16 varchar(16),
	@TitleID tinyint
AS		
...
SET QUOTED_IDENTIFIER ON;
GO
create PROCEDURE [dbo].[_UpdateTitleColor]
            @CharName16 varchar(16),
            @ColorCode varchar(100)
        AS
        BEGIN
